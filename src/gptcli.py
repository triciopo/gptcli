...
def print_response(api_key, prompt, model, num_completions):
    """
    ...
    if num_completions == 1:
        output = post(api_key, prompt, model, num_completions)
        for chunk in output:
            if chunk:
        ...
        choices = post(api_key, prompt, model, num_completions).get("choices", [])
